...
public:
	...
	virtual bool Scatter(const ray_t& ray, const raycastHit_t& raycastHit, Color::color3_t& color, ray_t& scattered) const override { return false; }
	Color::color3_t GetEmissive() const override { return m_albedo * m_intensity; }

private:
	Color::color3_t m_albedo{ 1, 1, 1 };
	float m_intensity{ 1 };
};